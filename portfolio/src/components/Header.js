  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/CurtWal/Lab05-Deploy" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
          ...
          <Nav.Item>
            <Switch 
              ...
              uncheckedIcon={
                <span
                  className="iconify"
                  data-icon="emojione:waxing-gibbous-moon"
                  data-inline="false"
                  style={{
                    display: "block",
                    height: "100%",
